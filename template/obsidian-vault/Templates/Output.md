...
<!-- Every non-obvious claim above traces to one of these. Full citations, not wikilinks,
     if this is headed for PDF or audio — the reader will not have the vault. -->

1. 

---

**Provenance:** assembled from findings in this vault. Draft until `state: final`.
